...
<div id="page-wrap">
    ...
    <table width="100%">
        <tr>
            ...
            <td style="border: 0;" width="62%"><div id="logo" style="font-size:18px">
    ...
    <table id="items">
        ...
        <tr>
            ...
            <!-- Total value -->
            <td class="total-value" <?php if ($config['rtl'] != 1) { ?> style="text-align: right;" <?php } ?>>
                <div id="subtotal">
        ...
        <?php if ($d['tax1'] != '0.00' && $d['tax1'] != '') { ?>
            <tr>
                <td class="blank"> </td>
                <td colspan="<?php echo $col_span; ?>" class="total-line">
                    <?php echo $_L['Tax']; ?> (<?= round($d['taxrate'], 0); ?>%)
                </td>
                <td class="total-value" style="text-align: right;">
                    <div id="total">
                        <?= number_format($d['tax1'], 2, $config['dec_point'], $config['thousands_sep']) . $config['currency_code'] ?>
                    </div>
                </td>
            </tr>
        <?php } ?>
