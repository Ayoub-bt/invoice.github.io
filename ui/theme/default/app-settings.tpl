                ...
                <div class="panel-container">
                    <div class="panel-content">
                        ...
                        <form role="form" name="accadd" method="post" action="{$_url}settings/app-post">
                            ...
                            <!-- Phone -->
                            <div class="mb-3">
                                <label for="company_phone">{$_L['Phone']}</label>
                            ...
                            <!-- Email -->
                            <div class="mb-3">
                                <label for="company_email">{$_L['Application Name']}</label>
                            ...
                            {if empty($config['disable_invoicing'])}
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="caddress" name="caddress" rows="2">{$config['caddress']}</textarea>
                                </div>
                            ...
                            <button type="submit" class="btn btn-primary w-100">{$_L['Submit']}</button>
                        </form>
