            ...
            <div class="panel-content">
                <form class="form-horizontal" id="ib_modal_form">
                    ...
                    <div class="mb-3"><label for="rate">{$_L['Base Conversion Rate']}</label>
                        ...
                        <span class="help-block">{$_L['Enter the value of']} <strong id="selectedCurrency">1 {$val['code']}</strong> = ?{if isset($home_currency->iso_code)} {$home_currency->iso_code} {/if}</span>
                    </div>
