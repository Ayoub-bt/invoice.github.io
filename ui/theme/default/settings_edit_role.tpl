                ...
                <div class="panel-container">
                    <div class="panel-content">
                        <form action="{$_url}settings/edit_role_post/" method="post" accept-charset="utf-8">
                            <div class="mb-3"><label for="rname" class="control-label"> <small class="req text-danger">* </small>{$_L['Role Name']}</label><input type="text" id="rname" name="rname" class="form-control" value="{$role->rname}"></div>
                                    ...
                                    <table class="table table-bordered roles no-margin">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center bold">{$_L['All Data']}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
