                    ...
                    <div class="panel-content" id="ibox_form">
                        <form id="invform" method="post">
                            <div class="ibox-content">
                                    ...
                                    <table class="table invoice-table" id="invoice_items">
                                        ...
                                        {foreach $items as $item}
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control qty" value="{if ($config['dec_point']) eq ','}{$item['qty']|replace:'.':','}{else}{$item['qty']}{/if}" name="qty[]">
                                                </td>
                                                <td>
                                                    <input type="number" class="form-control item_price" name="amount[]" value="{if ($config['dec_point']) eq ','}{(int)$item['amount']|replace:'.':','}{else}{$item['amount']}{/if}">
                                                </td>
                                                    <td class="ltotal"><input type="text" class="form-control lvtotal" readonly="" value="{if ($config['dec_point']) eq ','}{(int){$item['total']}|replace:'.':','}{else}{{$item['total']}}{/if}">
                                                </td>
                                                <td>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="sub_total" class="amount" data-a-sign="" data-a-dec="{$config['dec_point']}"
                                                        ...
                                                        {formatCurrency($d['subtotal'],$config['home_currency'])}
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="discount_amount_total" class="amount" data-a-sign=""
                                                        data-a-dec="{$config['dec_point']}" data-a-sep="" data-d-group="2">
                                                        -{formatCurrency($d['discount'],$config['home_currency'])}
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="taxtotal" class="amount" data-a-sign="" data-a-dec="{$config['dec_point']}"
                                                        data-a-sep="" data-d-group="2">
                                                        {formatCurrency($d['tax1'],$config['home_currency'])}
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="total" class="amount" data-a-sign="" data-a-dec="{$config['dec_point']}"
                                                        data-a-sep="" data-d-group="2">
                                                        {formatCurrency($d['total'],$config['home_currency'])}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <!-- Notes -->
                                <div class="mb-3">
                                    <label for="customer_notes">{$_L['Terms']}</label>
                                ...
                                <div class="text-center">
                                    ...
                                    <button class="btn btn-primary m-2" id="submit">
                                        {$_L['Save']}
                                        <button class="btn btn-info m-2" id="save_n_close"><i class="fal fa-check"></i> {$_L['Save n Close']}</button>
                                    </button>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number" class="form-control" id="discount_amount" name="discount_amount" value="{if ($config['dec_point']) eq ','}{(int)$d['discount_value']|replace:'.':','}{else}{$d['discount_value']}{/if}">
                                            </div>
