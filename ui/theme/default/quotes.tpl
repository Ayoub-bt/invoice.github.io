...
{block name="content"}
    <div class="panel">
        ...
        <div class="panel-hdr">
            <h2>{$_L['Quotes']} ({$total_quote})</h2>
            <div class="panel-toolbar">
                <div class="btn-group">
                    <a href="{$_url}quotes/new" class="btn btn-primary  btn-sm"> {$_L['Create New Quote']}</a>
                </div>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped w-100" id="clx_datatable">
                        ...
                        {foreach $d as $ds}
                            <tr>
                                <!-- Num -->
                                <td data-value="{$ds['id']}" data-order="{$ds@iteration}">
                                    <a href="{$_url}quotes/view/{$ds['id']}/">{$ds['invoicenum']}{if $ds['cn'] neq ''} {$ds['cn']} {else} {$ds['id']} {/if}</a>
                                </td>
                                ...
                                <!-- Amount -->
                                <td class="amount">{formatCurrency($ds['total'],$config['home_currency'])}</td>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <a href="{$_url}delete/quote/iid{$ds['id']}" id="iid{$ds['id']}" onclick="return confirm('Are you sure?');" class="btn btn-danger btn-icon waves-effect waves-themed has-tooltip cdelete" data-title="{$_L['Delete']}" data-placement="top"><i class="fal fa-trash"></i> </a>
                                    </div>
                                </td>
                            </tr>
                        {/foreach}
